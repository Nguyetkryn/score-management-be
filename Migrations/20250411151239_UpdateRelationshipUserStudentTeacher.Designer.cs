...
namespace score_management_be.Migrations
{
    ...
    [Migration("20250411151239_UpdateRelationshipUserStudentTeacher")]
    partial class UpdateRelationshipUserStudentTeacher
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("score_management_be.Models.UserRole", b =>
                {
            ...
            modelBuilder.Entity("score_management_be.Models.StudentUser", b =>
                {
                    b.HasOne("score_management_be.Models.Student", "Student")
                        .WithOne("StudentUser")
                        .HasForeignKey("score_management_be.Models.StudentUser", "StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("score_management_be.Models.User", "User")
                        .WithOne("StudentUser")
                        .HasForeignKey("score_management_be.Models.StudentUser", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("score_management_be.Models.TeacherUser", b =>
                {
                    b.HasOne("score_management_be.Models.Teacher", "Teacher")
                        .WithOne("TeacherUser")
                        .HasForeignKey("score_management_be.Models.TeacherUser", "TeacherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("score_management_be.Models.User", "User")
                        .WithOne("TeacherUser")
                        .HasForeignKey("score_management_be.Models.TeacherUser", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
